...
def process_image(image_path , detector , recognizer ,output_frames_dir = "./data/processed/frames_output"):
...
def process_video_from_webcam(detector, recognizer, output_frames_dir="./data/processed/frames_output"):
    """
...
def process_video(video_path,detector , recognizer , output_frames_dir="./data/processed/frames_output" ):
