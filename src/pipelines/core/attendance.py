...
def get_frame_attendance(image_path,detector , recognizer,frame_count,output_frames_dir="./data/processed/frames_output" ):
...
def get_attendance_from_video(video_path, output_frames_dir="./data/processed/frames_output"):
    ...
    #create buffer
    temp_dir = "./data/processed/temp_frames"
